...
dependency "function_app"   { config_path = "../function-app"; mock_outputs = { principal_id = "00000000-0000-0000-0000-000000000000" } }
...
inputs = {
  ...
  function_principal_id      = dependency.function_app.outputs.principal_id
}